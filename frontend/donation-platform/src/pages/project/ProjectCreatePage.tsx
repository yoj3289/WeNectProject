...
import { Upload, X, Image as ImageIcon, Bold, Italic, List, AlignLeft, FileText, CheckCircle } from 'lucide-react';
...
const CreateProjectPage: React.FC<CreateProjectPageProps> = ({
  ...
  const handlePlanUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    alert(`사용계획서가 업로드되었습니다: ${file.name}`);
  };
  ...
  const nextStep = () => {
    if (currentStep === 1) {
      ...
      if (Number(targetAmount) < 1000000) {
        alert('목표 금액은 최소 100만원 이상이어야 합니다.');
        return;
      }
    } else if (currentStep === 3) {
      if (!description.trim()) {
        alert('프로젝트 상세 설명을 입력해주세요.');
        return;
      }
    }
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <label
                ...
                className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-red-500 transition-colors"
              >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 border-2 border-blue-200 rounded-xl p-6">
              ...
              {planDocument ? (
                ...
                <label
                  htmlFor="plan-upload"
                  className="flex flex-col items-center justify-center w-full h-32 bg-white border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-blue-500 transition-colors"
                >
